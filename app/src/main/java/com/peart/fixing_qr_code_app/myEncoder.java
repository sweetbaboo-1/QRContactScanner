...
/**
 * myEncoder is an edited file from a gitHub library that was almost what we wanted it to do.
 * this file contatins the logic for encoding a string as a QR Code. We had to fix CONTACT QR Code
 * funcionality in order to allow the scanner to properly i.d. the QR Code as a contact.
 **/

//Edited by Matthew Peart in conjunction with Denzil Museruka
public class myEncoder {
    ...
    public myEncoder(String data, String type) {
        encoded = encodeContents(data, null, QRGContents.Type.TEXT);
    }

    public myEncoder(String data, String type, int dimension) {
        this.dimension = dimension;
        encoded = encodeContents(data, null, QRGContents.Type.TEXT);
    }

    public myEncoder(String data, Bundle bundle, String type, int dimension) {
        this.dimension = dimension;
